...
logger = setup_server_logging("mcp_location_server", PROJECT_ROOT, JsonFormatter)
...
@tool_meta(tags=["read","external"],triggers=["my location","where am i","current location","where do i live","location of","where is","geolocate","find location"],idempotent=True,template='use get_location_tool [city=""] [state=""] [country=""]')
...
@mcp.tool()
@check_tool_enabled(category="location")
@tool_meta(tags=["read","external"],triggers=["what time","current time","what date","time now","what's the time","time in","current date","what time is it"],idempotent=False,template='use get_time_tool [city=""] [state=""] [country=""]')
...
@mcp.tool()
@check_tool_enabled(category="location")
@tool_meta(tags=["read","external"],triggers=["weather","temperature","forecast","rain","snow","wind","will it rain","is it cold","weather today","weather tomorrow","what's the weather","how cold is it"],idempotent=False,template='use get_weather_tool [city=""] [state=""] [country=""] [forecast_days=""]')
