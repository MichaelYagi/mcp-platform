...
logger = setup_server_logging("mcp_github_server", PROJECT_ROOT, JsonFormatter)
...
@mcp.tool()
@check_tool_enabled(category="github")
@tool_meta(tags=["read","external","code"],triggers=["list files in repo","repo files","show repo files","files in repo","what files in repo","list repository files"],idempotent=True,template='use github_list_files: local_path="" [extensions=""] [exclude_dirs=""]',intent_category="github_review")
...
@mcp.tool()
@check_tool_enabled(category="github")
@tool_meta(tags=["read","external","code"],triggers=["get file from repo","read repo file","show file in repo","open repo file","view file in repo","read file from repo"],idempotent=True,template='use github_get_file_content: local_path="" file_path=""',intent_category="github_review")
...
@mcp.tool()
@check_tool_enabled(category="github")
@tool_meta(tags=["read"],triggers=["list capabilities","what can you do"],idempotent=True,template="use list_capabilities",intent_category="github_review")
