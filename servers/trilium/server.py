...
def make_request(method: str, endpoint: str, data: Optional[dict] = None, params: Optional[dict] = None, expect_json: bool = True) -> dict:
    """
...
def search_notes(query: str, limit: Optional[int] = 50, include_content: Optional[bool] = True) -> str:
    ...
    Args:
        query: Search query (str, required. e.g., "meeting notes", "#project")
...
def search_by_label(label: str, value: Optional[str] = None, limit: Optional[int] = 50) -> str:
    ...
    Args:
        ...
        value: Optional label value (str, optional. e.g., "active", "high")
        limit: Maximum number of results (default: 50)
...
def create_note(
    ...
    Args:
        ...
        title: Note title
        content: Note content (str, optional. Default: empty)
...
def add_label_to_note(note_id: str, label: str, value: Optional[str] = None) -> str:
    ...
    Args:
        ...
        value: Optional label value (str, optional. e.g., "high", "website", "active")
...
def get_recent_notes(limit: Optional[int] = 20) -> str:
    ...
    # Search with wildcard sorts by dateModified desc to get recently modified notes.
    # The '*' query matches all notes; orderBy/orderDirection are supported params.
    result = make_request(
        method="GET",
        endpoint="/notes",
        params={
